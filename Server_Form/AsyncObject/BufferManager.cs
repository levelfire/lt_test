...
namespace servercore
{
    ...
    /// </summary>
    /// <remarks>The operations exposed on the BufferManagerA class are not thread safe.</remarks>
    internal sealed class BufferManagerA
    {
        /// <summary>
        ...
        internal BufferManagerA(Int32 totalBytes, Int32 bufferSize)
        {
